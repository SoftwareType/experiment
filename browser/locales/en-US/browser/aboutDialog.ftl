...
community-exp = <label data-l10n-name="community-exp-mozillaLink">Mozilla</label> is a <label data-l10n-name="community-exp-creditsLink">global community</label> working together to keep the Web open, public and accessible to all.

community-2 = { -brand-short-name } is developed by the <label data-l10n-name="community-mozillaLink">{ -vendor-short-name }</label>. This browser's purpose is to restore native design features.
